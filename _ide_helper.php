...
')
     ...
     */ 
         ...
         * 
         *
         * @see \JustSteveKing\KeyFactory\KeyFactoryServiceProvider::boot()
         * @param string $prefix
         * @param int|null $length
         * @static 
         */ 
        public static function key($prefix, $length = null)
        {
                        return \Illuminate\Support\Str::key($prefix, $length);
        }
