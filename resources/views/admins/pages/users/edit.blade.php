            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Edition admin</h3>
                    </div>
                    <div class="nk-block-head-content">
                ...
                <div class="card">
                    <div class="card-aside-wrap">
                        <div class="card-inner card-inner-lg">
                            <form action="{{ route('supper.admins.update', $admin->key) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row  gy-4">
                                    <div class="col-md-6">
                                ...
                                <div class="form-group mt-3">
                                    <button type="submit" class="btn btn-sm btn-outline-primary">Update admin</button>
                                </div>
                            </form>
                        </div>
                    </div>
