<div class="site-sidebar">
    <div class="custom-scroll custom-scroll-light">
        <ul class="sidebar-menu" id="first_sidebar">
            ...
            <li>
                <div id="local_div"><img src="https://kepasa.africa/logo3.png" width="100%"></div>
            </li>
        </ul>
...
{{--                            </div>--}}
        ...
        <ul class="sidebar-menu" id="third_sidebar">
            <li >
                <a class="nav-link b-r-0" href="https://kepasa.africa/"  target="_blank" style="border-left: none !important;">
                    &copy; {{ now()->format('Y') }} ngomadigitech
                </a>
            </li>
        </ul>
    </div>
