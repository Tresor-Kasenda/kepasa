...
var options = {
    ...
    player: {
        ...
        loader: {
            show: false,
            url: window.site_url + "test/img/loader.gif",
            style: "default",
            class: ""
        },
        backgroundImg: window.site_url + "test/img/player-bg.gif"
    },
    toolbar: {
        displayMode: "auto",
        ...
        branding: {
            ...
            target: "new",
            logo: window.site_url + "test/img/enablex.png",
            title: "EnableX",
            position: "right"
        }
    }
...
function audioMute() {
    ...
    var onImgPath = window.site_url + "test/img/mic.png",
        onImgName = "mic.png";
    var offImgPath = window.site_url + "test/img/mute-mic.png",
...
function videoMute() {
    ...
    var onImgPath = window.site_url + "test/img/video.png",
        onImgName = "video.png";
    var offImgPath = window.site_url + "test/img/mute-video.png",
